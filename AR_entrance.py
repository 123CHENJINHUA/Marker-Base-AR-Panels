...
class AR_render:
    ...
    def capture_frame(self):
        ...
        pixels = glReadPixels(0, 0, self.width, self.height, GL_BGR, GL_UNSIGNED_BYTE)
    ...
    def save_video(self, filename='output.mp4', fps=30):
        ...
        out2 = cv2.VideoWriter(filename2, fourcc, fps, (self.width, self.height))
    ...
    def draw_objects(self, image, mark_size):
        ...
        if np.all(ids != None):
            ...
            rvec, tvec ,_ = aruco.estimatePoseSingleMarkers(corners, mark_size, self.cam_matrix, self.dist_coefs)
...
if __name__ == "__main__":
    ...
    ar_instance = AR_render(mtx, dist, './Models/Panels/SolarPanel.obj', model_scale = 0.005) #make it to mm
    ar_instance.run() 